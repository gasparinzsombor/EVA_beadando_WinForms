...
namespace View
{
    public partial class GameForm : Form
    {
        ...
        public GameForm()
        {
            ...
            _model.GameRunningChange += Model_GameRunningChange;
        ...
        private void Model_Load(object sender, EventArgs e)
        {
            ...
            timeStatusLabel.Text = "0";
        }

        private void Model_GameRunningChange(object sender, EventArgs e)
        {
            if(_model.GameIsRunning)
            {
                timer.Start();
        ...
        private void OpenMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                _model.OpenFile(openFileDialog.FileName);
            }
        }
